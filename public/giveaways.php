...
<?php if ($images): ?>
  <div class="giveaways-grid giveaways-grid--<?= count($images) >= 3 ? 3 : count($images) ?>">
    <?php foreach ($images as $img): ?>
      <div class="card" style="min-height:240px;"><div class="card__img media-fixed"><img src="<?= e($img) ?>" alt="giveaway"></div></div>
    <?php endforeach; ?>
  </div>
<?php endif; ?>
</div></div></section>
